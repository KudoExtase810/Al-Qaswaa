        ...
        <>
            ...
            <div className="relative w-max">
                <input
                    ...
                    type="text"
                    name="search"
                    className="my-3 px-2 py-1 text-zinc-900 border border-zinc-400 dark:border-gray-900 hover:border-zinc-800 dark:bg-gray-800 dark:text-gray-100 focus:outline-2 focus:outline-blue-600 dark:focus:outline-orange-500 rounded-md w-[350px] md:w-[600px]"
                />
